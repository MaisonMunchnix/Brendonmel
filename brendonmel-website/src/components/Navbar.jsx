...
const Navbar = () => {
  ...
  return (
    <div className='fixed top-0 left-0 w-full z-1000'>
        <div className='container mx-auto flex justify-between items-center py-4 px-6 md:px-20 lg:px-32 bg-black max-w-full'>
            <img src={assets.logo} alt="brendonmel logo" />
            ...
            <button className='hidden md:block bg-white px-8 py-2 rounded-full'><a href="https://www.facebook.com/brendonmel2016/">Visit Us</a></button>
        ...
        <div className={`md:hidden  ${showMobileMenu ? 'fixed w-full' : 'h-0 w-0'} right-0 top-0 bottom-0 overflow-hidden bg-white transition-all`}>
          <div className='flex justify-end p-6 cursor-pointer transition-all' onClick={() => {setShowMobileMenu(false)}}>
